        ...
        ColumnLayout {
            ...
            Item {
                ...
                Column {
                    ...
                    TextApp {
                        text: qsTr("The cycle count will increase by 0.5 points\nevery time the sash hits a safe height")
                        color: "#cccccc"
                        font.pixelSize: 16
                    }//
                ...
                MouseArea {
                    ...
                    onClicked: {
                        KeyboardOnScreenCaller.openNumpad(newValueTextField, qsTr("Reset Sash Cycle (must be increased by 0.5)"))
                    }//
                }//
                ...
                TextFieldApp {
                    ...
                    onAccepted: {
                        ...
                        if(val % 0.5) {
                            showDialogMessage(qsTr("Reset Sash Cycle"),
                                              qsTr("Input is not valid!") + "<br>" + qsTr("Sash cycle count must be increased by 0.5."),
                                              dialogAlert)
                            return
                        }

                        MachineAPI.setSashCycleMeter(val * 10)
