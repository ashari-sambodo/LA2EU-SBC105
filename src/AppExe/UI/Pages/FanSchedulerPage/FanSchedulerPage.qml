...
ViewApp {
    ...
    content.sourceComponent: ContentItemApp {
                ...
                Rectangle {
                    ...
                    Item {
                        ...
                        ButtonBarApp {
                            ...
                            onClicked: {
                                visible = false
                                MachineAPI.setFanAutoTime(props.timeSet)
                                MachineAPI.setFanAutoDayRepeat(props.repeatSet)
                                MachineAPI.setFanAutoWeeklyDay(props.repeatDaySet)
                                MachineAPI.setFanAutoEnabled(props.enableSet)

                                const message = props.enableSet ? qsTr("User: Fan Scheduler enabled")
                                                                : qsTr("User: Fan Scheduler disabled")
        ...
        Component.onCompleted: {
            ...
            const minutesSchedule = MachineData.fanAutoSetTime
            ...
            let repeat = MachineData.fanAutoSetDayRepeat
            props.repeatSet = repeat
            let day = MachineData.fanAutoSetWeeklyDay
            ...
            enableSwitch.checked = MachineData.fanAutoSetEnabled
