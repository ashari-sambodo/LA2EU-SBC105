...
ApplicationWindow {
    ...
    Settings{
        ...
        function setDisplayTheme(value){
            settings.displayTheme = value
        }

        Component.onCompleted: {
            MachineData.displayThemeChanged.connect(settings.setDisplayTheme)
        }
    }
    ...
    Item{
        ...
        StackViewApp {
            ...
            property string homeURL: UserSessionService.loggedIn ? "qrc:/UI/Pages/_HomePage/HomePage.qml"
                                                                 : "qrc:/UI/Pages/LoginPage/LoginPage.qml"
