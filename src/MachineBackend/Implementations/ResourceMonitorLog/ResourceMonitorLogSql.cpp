...
#define DB_QUERY_DELETE_OLDEST_ROWID        "DELETE FROM resourcemonitorlog_V1 WHERE ROWID = (SELECT ROWID FROM resourcemonitorlog_V1 ORDER BY ROWID LIMIT 1)"
#define DB_QUERY_COUNT_ROWS                 "SELECT COUNT(*) FROM resourcemonitorlog_V1"

//#define DB_QUERY_SELECT_WITH_OFFSET_LIMIT_ASC        "SELECT * FROM resourcemonitorlog_V1 ORDER BY ROWID ASC LIMIT :limit OFFSET :offset;"
//#define DB_QUERY_SELECT_WITH_OFFSET_LIMIT_DESC       "SELECT * FROM resourcemonitorlog_V1 ORDER BY ROWID DESC LIMIT :limit OFFSET :offset;"

//#define DB_QUERY_SELECT                     "SELECT * FROM resourcemonitorlog_V1"
