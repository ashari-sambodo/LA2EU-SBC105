...
public slots:
  ...
  void saveInflowMeaSecNominalGrid(const QJsonArray grid, int total,
                                   int average, int velocity, int ducy,
                                   int rpm);
  ///
  // DOWNFLOW
  ...
  void setDownflowAdcPointFactory(int pointZero, int pointMin, int pointNom,
                                  int pointMax);
  void setDownflowAdcPointFactory(int point, int value);
  void setDownflowVelocityPointFactory(int pointZero, int pointMin,
  ...
  void saveDownflowMeaNominalGrid(const QJsonArray grid, int total,
                                  ...
                                  int velocityHighest, int deviation,
                                  int deviationp, int ducy, int rpm,
                                  int fullField = 0);
...
private:
  ...
  void _onModbusDataWritten(QModbusDataUnit::RegisterType table, int address,
                            int size);
  ...
  void _setSoftwareUpdateAvailable(QString swu, QString path,
                                   QJsonObject history);
  ...
  // int  m_sashMotorizedOffAtFullyClosedDelayTimeMsec = 500; /// 500ms for 6
  // feet /// 700ms for 4 feet
  ...
  short m_delaySashMotorUpAfterStucked =
      1500; /// 1500ms for 6ft /// 1000ms for 4ft
