...
void MachineBackend::setup()
{
    ...
    /// TEMPERATURE
    {
        ...
        if (pData->getMeasurementUnit()) {
            ...
            QString valueStr = QString::asprintf("%d째F", temp);
            pData->setTemperatureValueStrf(valueStr);
        }
        else {
            pData->setTemperature(static_cast<short>(temp));
            QString valueStr = QString::asprintf("%d째C", temp);
            pData->setTemperatureValueStrf(valueStr);
        }
    }
...
void MachineBackend::setMeasurementUnit(short value)
{
    ...
    if (value) {
        ...
        QString valueStr = QString::asprintf("%d째F", _tempFahrenheit);
        pData->setTemperatureValueStrf(valueStr);
        ...
        QString valueStr = QString::asprintf("%d째C", static_cast<short>(_tempCelsius));
        pData->setTemperatureValueStrf(valueStr);
...
void MachineBackend::_onTemperatureActualChanged(int value)
{
    ...
    if (pData->getMeasurementUnit()) {
        ...
        valueStr = QString::asprintf("%d캟", fahrenheit);
        pData->setTemperatureValueStrf(valueStr);
        ...
        valueStr = QString::asprintf("%d캜", value);
        pData->setTemperatureValueStrf(valueStr);
